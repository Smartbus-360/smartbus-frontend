...
import { Button, TextField, Snackbar, Alert, MenuItem, FormControlLabel, FormControl, InputLabel, Select,
...
const BusNotifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await axiosInstance.get("bus-notifications");
      const busResponse = await axiosInstance.get("buses");
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post("bus-notifications/create", newNotification);

      setNewNotification({ message: "", busId: "", expiryDate: "", isMandatory: false });
      fetchNotifications();
